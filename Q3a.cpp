...
int main() {
	...
	/* All the expressions are valid because the difference between characters 
   is stored as the difference between their integer ASCII values.
   The difference in ASCII values between 'a' and 'e' is the same as 
   the difference between 'A' and 'E'.
*/ 
